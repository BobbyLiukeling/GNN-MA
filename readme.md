...
In this study, we formulate LBVS as a pairwise scoring problem between a query molecule ![img](imgs/\wps5.jpg) and a candidate molecule ![img](imgs/\wps6.jpg). The model outputs a matching score ![img](imgs/\wps7.jpg), based on which the candidate set is ranked to achieve early enrichment. During training, we use labeled molecular pairs ![img](imgs/\wps8.jpg), where ![img](imgs/\wps9.jpg).

***\*3.2 Molecular Graph Representation and Input Features\****

We represent each molecule as a graph ![img](imgs/\wps10.jpg), where ![img](imgs/\wps11.jpg) is the atom feature matrix, ![img](imgs/\wps12.jpg) is the number of atoms, ![img](imgs/\wps13.jpg) is the node-feature dimension, ![img](imgs/\wps14.jpg) is the bond feature tensor, ![img](imgs/\wps15.jpg) is the edge-feature dimension. To support practical LBVS with heterogeneous input availability, we adopt a dimension-agnostic design. The model uses 2D topology with atom/bond attributes by default, and integrates 3D information as an optional augmentation when present.  Tables 1 and 2 summarize the feature categories.
...
To learn intra-molecular structural semantics, GNN-MA performs ![img](imgs/\wps16.jpg)-th layer message passing on the query graph ![img](imgs/\wps17.jpg) and the candidate graph ![img](imgs/\wps18.jpg) separately. Given the (![img](imgs/\wps19.jpg)-1)th layer node embedding ![img](imgs/\wps20.jpg) and the edge (bond) representation ![img](imgs/\wps21.jpg) between nodes ![img](imgs/\wps22.jpg) and ![img](imgs/\wps23.jpg), node ![img](imgs/\wps24.jpg) aggregates messages from its neighborhood ![img](imgs/\wps25.jpg) as follows:
...
Let ![img](imgs/\wps30.jpg)and ![img](imgs/\wps31.jpg) denote the atom representations of the two compounds after intra-molecular message passing, where ![img](imgs/\wps32.jpg) and ![img](imgs/\wps33.jpg) are the numbers of atoms, ![img](imgs/\wps34.jpg) is the embedding dimension. We use scaled dot-product attention to compute the cross-graph relevance between the ![img](imgs/\wps35.jpg)-th atom in the query molecule ![img](imgs/\wps36.jpg) and the ![img](imgs/\wps37.jpg) atom in the candidate molecule ![img](imgs/\wps38.jpg) :

![img](imgs/\wps39.jpg) 

Here, ![img](imgs/\wps40.jpg) and ![img](imgs/\wps41.jpg) are learnable parameters, and ![img](imgs/\wps42.jpg) is the scaling factor used in the attention mechanism.

For each query atom ![img](imgs/\wps43.jpg), we normalize over all candidate atoms ![img](imgs/\wps44.jpg) by applying a softmax along the candidate-atom dimension, yielding the soft alignment weights from query to candidate:

![img](imgs/\wps45.jpg) 

Based on these weights, query atom ![img](imgs/\wps46.jpg) aggregates information from the candidate molecule to obtain a cross-graph contextual representation:

![img](imgs/\wps47.jpg) 

To enhance the symmetry of alignment and the complementarity of information, we similarly compute the reverse attention ![img](imgs/\wps48.jpg) and obtain ![img](imgs/\wps49.jpg). 
...
Here, ![img](imgs/\wps51.jpg) is a learnable mapping that integrates node semantics and bond information to produce an enhanced bond representation.
...
Here, ![img](imgs/\wps54.jpg) is a learnable mapping that transfers bond-level information to atom-level representations, facilitating subsequent fusion with atom features.
...
First, the model outputs a matching score ![img](imgs/\wps57.jpg) for each query–candidate molecular pair. During training, we use the binary cross-entropy loss ![img](imgs/\wps58.jpg) as the primary supervision signal for active/decoy classification. In addition, we introduce a within-target pairwise ranking constraint ![img](imgs/\wps59.jpg): from the negative set, we select the Top-K hardest negatives (hard negatives) and explicitly enforce their scores to be lower than those of positive samples, thereby strengthening early enrichment. The overall objective is finally defined as:
