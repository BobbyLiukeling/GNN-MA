...
## 7. Pretrained Checkpoints and predict
...
Prediction outputs and logs generated by the training/evaluation scripts can be used to reproduce the reported metrics and tables.
